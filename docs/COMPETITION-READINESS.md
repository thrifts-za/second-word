...
| --- | --- | --- |
| **Live Gloo AI Studio** | **Red: provider access issue under investigation** | On 2026-07-21, Gloo support acknowledged a similar issue affecting another participant and said its team is investigating the cause and resolution. This does not prove the cause or make Gloo live. Set the eventual secrets and provider configuration; `REQUIRE_GLOO=1 npm run preflight` must pass against production before claiming live use. |
